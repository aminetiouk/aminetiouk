...
<div style="font-family: Arial, sans-serif; font-size: 1.2em; line-height: 1.6; color: #333; max-width: 700px; margin: 0 auto; padding: 20px; background-color: #f9f9f9; border-radius: 10px; box-shadow: 0px 4px 8px rgba(0, 0, 0, 0.1);">
  ...
  <p style="font-weight: 600; font-size: 1.3em; color: #2b6cb0;">
    👨‍💻 I am a Front-End Developer with expertise in JavaScript (ES6+) / TypeScript, React, Redux, and HTML/CSS, focused on creating responsive, user-centered web applications.
  </p>
  <p>
    🎓 Recently graduated from the <strong>ALX Software Engineering Program</strong>, where I specialized in front-end development, mastering modern technologies to build high-quality, interactive web applications. 🚀
  </p>
</div>
<br/>
<!-- Social Links -->
...
<div align="center">
  <a href="https://skillicons.dev">
    <img src="https://skillicons.dev/icons?i=git,javascript,typescript,react,nextjs,html,css,sass,tailwind,threejs,vite,bootstrap,figma,redux,webpack,kubernetes,docker,c,flask,babel,firebase,linux,mysql,nodejs,npm,py,ai,ae,ps,pr&perline=10" />
  </a>
</div>
<br/>
